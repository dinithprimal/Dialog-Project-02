<?php
    ...
    $mail->Subject = ''.$progType.' Training Program Approval Request: '.$progName.' '.$progType.' Training';
    ...
    if(!$mail->send()){
        ...
        $updateQuery = "UPDATE programstatus SET progApprGCTO= '1' , reqDtApprGCTO = '$Dt', GCTOConfirm = '$cnfirm' WHERE idProgram = '$id'";
