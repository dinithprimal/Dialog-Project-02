<?php
    ...
    if(isset($_POST['newProgram'])){
        ...
        header("location: newDashboardProgram.php");
    }
    ...
    <body>
                    ...
                    <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
                        <div class="row pt-md-1 mt-md-2 mb-auto">
                            <div class="container">
                                            ...
                                            <div class="card card-common2 mt-2" style="border-radius: 5px 5px 0px 0px;">
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-2">
                                                            <div class="row">
                                                                <div class ="col divbody d-flex align-items-center">
                                                                    <form action="trainingDashboard.php" method="POST">
                                                                        <button type="submit" name="newProgram" class="btn btn-sm btn-info float-right">Add New Program</button>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-12">
                                                            <div class="row">
                                                                <div class="col">
                                                                    <div class="panel panel-default card rounded" style="auto;">
                                                                        <div class="card-header">
                                ...
                                ?>
                                    <div class="col">
                                        <div class="card p-2 text-danger" align="center">
                                            No programs to preview
                                        </div>
                                    </div>
                                <?php
                                    }
        ...
        <script type="text/javascript">
            ...
            var myLineChart = new Chart(ctxD, {
                ...
                data: {
                    labels: ["Pendings","Ongoing", "Delivered" , "Canceled/Rejected"],
                    legendText: "{label} :",
                    datasets: [{
                        data: [
                            <?php 
                                $queryPendings = "SELECT COUNT(*) AS Pendings FROM programstatus WHERE ((progApprGTD IN (0,1) OR statusCXO1 IN (0,1) OR progApprGCTO IN (0,1) OR progApprGCEO IN (0,1)) OR (progModuleStatus = 'Pending' OR progNomStatus = 'Pending')) AND (progApprGTD !=3 AND statusCXO1 != 3 AND progApprGCTO != 3 AND progApprGCEO != 3) AND cancelStatus != 1 AND deliveryStatus = 0 AND remark = '$remark'";
                            ...
                            ,
                            <?php
                                $queryOngoing = "SELECT COUNT(*) AS OngoingCount FROM programstatus WHERE ((progApprGTD IN (2) AND statusCXO1 IN (2) AND progApprGCTO IN (2) AND progApprGCEO IN (2,4))) AND deliveryStatus = 0 AND (progModuleStatus != 'Pending' AND progNomStatus != 'Pending') AND cancelStatus != 1 AND remark = '$remark'";
                            ...
                            ,
                            <?php 
                                $queryRejected = "SELECT COUNT(*) AS rejected FROM programstatus WHERE ((progApprGTD = 3 OR statusCXO1 = 3 OR progApprGCTO = 3 OR progApprGCEO = 3) OR cancelStatus = 1) AND remark = '$remark'";
