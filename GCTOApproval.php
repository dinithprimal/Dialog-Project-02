        ...
        <div class="container-fluid bg">
            <?php
                if($GCTOis==1 & $GCTOconfirm['GCTOConfirm'] == $cnfrm){
                    if($GCTOStage == '1'){
                        $updateAccept = "UPDATE programstatus SET progApprGCTO= '2' , dtApprGCTO = '$Dt' WHERE idProgram = '$id'";
                        if ($conn->query($updateAccept) === TRUE) {

                            echo    '<script type="text/javascript"> 
                                        function sendMailAproveGCTO(){
                                            var id = '.$id.';
                                            $.ajax({
                                                url: "sendMailAproveGCTO.php",
                                                method: "POST",
                                                data: {id:id},
                                                dataType: "text",
            ...
            ?>
                ...
                <div class="row mt-5 pt-5">            
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="row mt-5">
                            <div class="col">
                                <h4 class="text-center"><small>You have succesfully accepted <b><?php  echo    "".$GCTOconfirm['progName']." ".$GCTOconfirm['progType']." ";    ?></b>training program</small></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-2 col-sm-12 col-xs-12"></div>
            ...
            <?php
                            ...
                            if($GCTOconfirm['progApprGCEO'] == 0){
                                echo    '<script>
                                            function sendMailGCEO(){
                                                var id = '.$id.';
                                                $.ajax({
                            ...
                            }else if($GCTOconfirm['progApprGCEO'] == 4){
                                echo    '<script>
                                            function sendMailHR(){
                                                var id = '.$id.';
                                                $.ajax({
