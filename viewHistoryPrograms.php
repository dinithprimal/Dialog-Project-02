    ...
    <body>
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <?php
                            $queryShedule = "SELECT * FROM sheduleprogram WHERE id = '$spID'";
                        ...
                        <div class="col-xl-10 col-lg-9 col-md-9 ml-auto bg-dark fixed-top py-2 top-navbar">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <h4 class="text-light 
                                    text-uppercase mb-0"><?php  echo    $shedule['remark']; ?></h4>
                                </div>
                                <div class="col-md-5">
                    ...
                    <div class="col-xl-10 col-lg-9 col-md-9 ml-auto">
                        <div class="row pt-md-5 mt-md-3 pt-xs-5 mt-xs-3">
                            <div class="col-xl-4 col-sm-4 p-2">
                                <div class="card card-common" style="height:176px">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <i class="fas fa-info text-info"></i>
                                            <div class="text-right text-secondary">
                                                <h6 class="mb-1"><small><?php   echo    $shedule['remark']; ?></small></h6>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="card-programe pt-4 px-2 d-flex justify-content-between align-items-center">
                                                    <span class="float-left"><small><small>Start Date Time : </small></small></span>
                                                    <span class="float-right " style=" vertical-align: middle">
                                                        <small><small>
                                                            <?php   echo    $shedule['startdate']; ?>
                                                        </small></small>
                                                    </span>
                                                </div>
                                                <div class="card-programe pt-3 px-2 d-flex justify-content-between align-items-center">
                                                    <span class="float-left"><small><small>Sheduled End Date Time : </small></small></span>
                                                    <span class="float-right " style=" vertical-align: middle">
                                                        <small><small>
                                                            <?php   echo    $shedule['enddate']; ?>
                                                        </small></small>
                                                    </span>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="text-right text-secondary">
                                                ...
                                                ?>
                                                <h6 class="mb-1"><small>Total Number of Programs - <?php    echo    $totalProgram['tot'];   ?></small></h6>
                                            </div>
                                        </div>
                                        <div class="row my-3">
                                            <div class="col">
                                                <div class="card-programe pt-2 px-2 d-flex justify-content-between align-items-center">
                                                    <span class="float-left"><small><small>Foriegn : </small></small></span>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <span class="float-right " style=" vertical-align: middle"><small><small><?php  echo    $foriegnProgram['totf'];    ?></small></small></span>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="card-programe pt-2 px-2 d-flex justify-content-between align-items-center">
                                                    <span class="float-left"><small><small>Local : </small></small></span>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <span class="float-right " style=" vertical-align: middle"><small><small><?php echo    $localProgram['totl'];  ?></small></small></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                <div class="card-programe pt-2 px-2 d-flex justify-content-between align-items-center">
                                                    <span class="float-left"><small><small>Online : </small></small></span>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <span class="float-right " style=" vertical-align: middle"><small><small><?php  echo    $onlineProgram['toto']; ?></small></small></span>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="card-programe pt-2 px-2 d-flex justify-content-between align-items-center">
                                                    <span class="float-left"><small><small>Internal : </small></small></span>
                                                    <?php
                                                    ...
                                                    ?>
                                                    <span class="float-right " style=" vertical-align: middle"><small><small><?php  echo    $internalProgram['toti'];   ?></small></small></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card card-common" style="height:176px">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between">
                                            <i class="fas fa-info text-info"></i>
                                            <div class="text-right text-secondary">
                                                <h6 class="mb-1"><small>Number of Programs for each Division</small></h6>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col" style="height:115px; width:100%; overflow: auto; overflow-x: hidden;">
                                            <?php
                                            ...
                                            ?>
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="card-programe pt-2 px-2 d-flex justify-content-between align-items-center">
                                                            <span class="float-left"><small><small><?php    echo    $department['Department'];  ?> : </small></small></span>
                                                            <?php
                                                            ...
                                                            ?>
                                                            <span class="float-right " style=" vertical-align: middle"><small><small><?php  echo    $countDepartment['count'];  ?></small></small></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            <?php
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12 col-md-6 px-5">
                                <button type="button" name="summury" style="display:inline-block;" id="summury" class="btn btn-info btn-sm btn-block">Export Summary</button>
                            </div>
                            <div class="col-sm-12 col-md-6 px-5">
                                <button type="button" name="export" style="display:inline-block;" id="export" class="btn btn-info btn-sm btn-block">Export Given Trainings Details</button>
                            </div>
                        </div>
                        <div class="row mt-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <small>
                                            <table id="programs" class="display" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th><small>Program Name</small></th>
                                                        <th><small>Trainer/Supp.</small></th>
                                                        <th><small>Type</small></th>
                                                        <th><small>Priority</small></th>
                                                        <th><small>Slots</small></th>
                                                        <th><small>Date Added</small></th>
                                                        <th><small>Modules</small></th>
                                                        <th><small>Nominees</small></th>
                                                        <th><small>Added Person</small></th>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><small><?php    echo    $program['ProgName'];   ?></small></td>
                                                        <td><small><?php    echo    $program['trasup'];   ?></small></td>
                                                        <td><small><?php    echo    $program['typ'];   ?></small></td>
                                                        <td><small><?php    echo    $program['prio'];   ?></small></td>
                                                        <td><small><?php    echo    $program['slot'];   ?></small></td>
                                                        <td><small><?php    echo    $programDetails['Dt'];  ?></small></td>
                                                        <td><small><?php    echo    $counrModule['totMod']  ?></small></td>
                                                        <td><small><?php    echo    $counrNominee['totNom'];    ?></small></td>
                                                        <td><small><?php    echo    $userDetails['fName'];  ?></small></td>
                                                        <td><small><?php    echo    $userDetails['Department']; ?></small></td>
                                                    </tr>
                                                <?php
                                                    }
                                                ?>
        ...
        <script type="text/javascript">
            ...
            $('#export').click(function(){
                location.href='exportHistoryExcell.php?id=<?php echo   $spID; ?>';
            });

            $('#summury').click(function(){
                location.href='exportSummury.php?id=<?php echo   $spID; ?>';
            });
