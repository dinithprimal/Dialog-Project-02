                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-10 col-lg-9 col-md-8 ml-auto bg-dark fixed-top py-2 top-navbar">
                            <div class="row align-items-center">
                                <div class="col-md-4">
                                    <h4 class="text-light 
                                    text-uppercase mb-0">MY PROGRAMS</h4>
                                </div>
                                <div class="col-md-5">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="myPrograms.php" method="POST">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
                        <div class="row pt-md-1 mt-md-5 mb-auto">
                            <div class="col">
                                <?php
                                    $remarkQuery = "SELECT id, remark FROM sheduleprogram ORDER BY id DESC";
                                    ...
                                    <div class="col">
                                        <div class="card">
                                            <div class="card-header">
                                                <div class="panel-title"><?php  echo    $arrayRemarkQuery['remark'];    ?></div>
                                            </div>
                                            <div class="card-body">
                                                <?php
                                                    $progcount = "SELECT idProgram, ProgName FROM program WHERE remark = '".$arrayRemarkQuery['remark']."' AND idprogram = ANY (SELECT idProgram FROM program_has_user WHERE idUser = '".$userId['idUser']."')";
                                                ...
                                                <?php
                                                        while($progs = mysqli_fetch_array($res)){
                                                ?>
                                                        <li class="mt-2"><a href="viewMyPrograms.php?spid=<?php echo    $arrayRemarkQuery['id']; ?>&pid=<?php echo    $progs['idProgram']; ?>&uid=<?php echo    $userId['idUser']; ?>" class="text-dark"><i class="fas fa-tasks text-dark fa-sm fa-fw mr-3"></i><?php  echo    $progs['ProgName'];    ?></a></li>
                                                <?php
                                                        }
                                                ?>
                                                    </ul>
                                ...
                                ?>
                                <div class="card card-common m-3">
                                    <div class="card-body">
                                        <h5 class="m-2 text-danger" style="text-align: center">You do not have any programs to view</h5>
                                    </div>
                                </div>
                                <?php
                                    }
