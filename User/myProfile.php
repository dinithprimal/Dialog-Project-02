<?php
    ...
    if(isset($_SESSION['username'])){
        ...
        $sql = "SELECT idUser, Password FROM logdetail WHERE Username = '$user'";
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row px-3 py-2" id="chpw">
                                            <div class="col" align="center">
                                                <button class="btn btn-sm btn-info" name="changePW" id="changePW">Change Password</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row px-3 py-2">
                                            <div class="col" align="center">
                                                <small><small>* If there any corrections to do, please contact administraion of this system.</small></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
