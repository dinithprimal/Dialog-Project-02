    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="trainingUserDashboard.php" method="POST">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="d-flex justify-content-between">
                                                                        ...
                                                                        <div class="text-right text-secondary">
                                                                            <a href="viewProgramsUser.php?id=<?php  echo    $queryAllProgs['idProgram'];    ?>" class="card-link text-blue"><h5><small>
                                                                            <?php
        ...
        <script type="text/javascript">
            ...
            var myLineChart = new Chart(ctxD, {
                ...
                data: {
                    labels: ["Pendings","To be Approved", "Delivered" , "Canceled"],
                    legendText: "{label} :",
                    datasets: [{
                        data: [
                            <?php 
