        ...
        <div class="container-fluid bg">
            <?php
                if($GTDis==1 & $GTDconfirm['GTDConfirm'] == $cnfrm){
                    if($GDTStage == '1'){
                        $updateAccept = "UPDATE programstatus SET progApprGTD= '2' , dtApprGTD = '$Dt' WHERE idProgram = '$id'";
                        if ($conn->query($updateAccept) === TRUE) {

                            echo    '<script type="text/javascript"> 
                                        function sendMailAproveGTD(){
                                            var id = '.$id.';
                                            $.ajax({
                                                url: "sendMailAproveGTD.php",
                                                method: "POST",
                                                data: {id:id},
                                                dataType: "text",
            ...
            ?>
                ...
                <div class="row mt-5 pt-5">            
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="row mt-5">
                            <div class="col">
                                <h4 class="text-center"><small>You have succesfully accepted <b><?php  echo    "".$GTDconfirm['progName']." ".$GTDconfirm['progType']." ";    ?></b>training program</small></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-2 col-sm-12 col-xs-12"></div>
