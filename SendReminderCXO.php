<?php
    ...
    $queryID = "SELECT idProgram, CXOid FROM cxoapproval WHERE progApprCXO1 = '1'";
    ...
    while($progDetailsID = mysqli_fetch_array($resultQueryID)){
        ...
        $cnfirm = $progDetails['CXO1Confirm'];
        $progScheduleComment = $progDetails['scheduleComment'];
        $progCXO1_1 = $progDetails['progApprCXO1'];
        $progCXO1_2 = $progDetails['progApprCXO1_2'];
        ...
        $mail->Subject = 'Reminder: Training Program Recommendation: '.$progName.' '.$progType.' Training';
