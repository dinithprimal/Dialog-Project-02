<?php
    ...
    $mail->Subject = ''.$progType.' Training Program Approval Request';
    ...
    if(!$mail->send()){
        ...
        $updateQuery = "UPDATE programstatus SET progApprGCEO= '1' , reqDtApprGCEO = '$Dt', GCEOConfirm = '$cnfirm' WHERE idProgram = '$id'";
