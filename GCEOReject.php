        ...
        <div class="container-fluid bg">
            <?php
                if($GCEOis==1 & $GCEOconfirm['GCEOConfirm'] == $cnfrm){
                    if($GCEOStage == '1'){
                        $updateReject = "UPDATE programstatus SET progApprGCEO= '3' , dtApprGCEO = '$Dt' WHERE idProgram = '$id'";
                        if ($conn->query($updateReject) === TRUE) {

                            echo    '<script type="text/javascript"> 
                                        function sendMailRejectGCEO(){
                                            var id = '.$id.';
                                            $.ajax({
                                                url: "sendMailRejectGCEO.php",
                                                method: "POST",
                                                data: {id:id},
                                                dataType: "text",
            ...
            ?>
                ...
                <div class="row mt-5 pt-5">            
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="row mt-5">
                            <div class="col">
                                <h4 class="text-center"><small>You have rejected <b><?php  echo    "".$GCEOconfirm['progName']." ".$GCEOconfirm['progType']." ";    ?></b>training program</small></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-2 col-sm-12 col-xs-12"></div>
