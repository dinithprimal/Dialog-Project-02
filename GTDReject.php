<?php
    ...
    $GTDis = mysqli_num_rows($cnfrmId);
    $GTDconfirm = mysqli_fetch_array($cnfrmId);
    $GDTStage = $GTDconfirm['progApprGTD'];
...
<html lang="en">
    ...
    <body>
        <div class="container-fluid bg">
            <?php
                if($GTDis==1 & $GTDconfirm['GTDConfirm'] == $cnfrm){
                    if($GDTStage == '1'){
                        $updateReject = "UPDATE programstatus SET progApprGTD= '3' , dtApprGTD = '$Dt' WHERE idProgram = '$id'";
                        if ($conn->query($updateReject) === TRUE) {

                            echo    '<script type="text/javascript"> 
                                        function sendMailRejectGTD(){
                                            var id = '.$id.';
                                            $.ajax({
                                                url: "sendMailRejectGTD.php",
                                                method: "POST",
                                                data: {id:id},
                                                dataType: "text",
            ...
            ?>
                ...
                <div class="row mt-5 pt-5">            
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-xs-12">
                        ...
                        <div class="row mt-5">
                            <div class="col">
                                <h4 class="text-center"><small>You have rejected <b><?php  echo    "".$GTDconfirm['progName']." ".$GTDconfirm['progType']." ";    ?></b>training program</small></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-2 col-sm-12 col-xs-12"></div>
